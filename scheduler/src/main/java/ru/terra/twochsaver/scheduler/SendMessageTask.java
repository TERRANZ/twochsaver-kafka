package ru.terra.twochsaver.scheduler;
...
public class SendMessageTask {
    ...
    private final DownloadSender producer;

    public SendMessageTask(DownloadSender producer) {
...
//    @Scheduled(fixedRateString = "3000")
    public void send() throws ExecutionException, InterruptedException {
        ...
        ListenableFuture<SendResult<String, String>> listenableFuture = this.producer.sendMessage(DOWNLOAD_TOPIC, "IN_KEY", LocalDate.now().toString());
